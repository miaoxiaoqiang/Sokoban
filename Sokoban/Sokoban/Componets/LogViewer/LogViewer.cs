...
namespace LogViewerLib
{
    ...
    public class LogViewer : RichTextBox
    {
        ...
        {
            WriteLog(new StyledString("", StringStyleEnum.normal, LineHandlingEnum.endOfLine));
        }


        public void WriteLine(string line)
        {
            WriteLog(new StyledString(line, LineHandlingEnum.endOfLine));
        }
        ...
        {
            WriteLog(new StyledString(line, LineHandlingEnum.temporaryEOL));
        }


        public void WriteLine(string line, StringStyleEnum stringStyle)
        {
            WriteLog(new StyledString(line, stringStyle, LineHandlingEnum.endOfLine));
        }
        ...
        private void WriteLog(StyledString styledString)
        {
            lock (stringBuffers)
            {
                ...
                if (!isWpfTimerActivated)
                {
                    ...
                    else
                    {
                        ...
                        this.Dispatcher.BeginInvoke(DispatcherPriority.Input, new Action(wpfTimer.Start));
                    }
                }
            }
        }
        ...
        private void Append(StyledString styledString)
        {
            ...
            String[] lineStrings = styledString.String.Split(new string[] { Environment.NewLine }, StringSplitOptions.None);
